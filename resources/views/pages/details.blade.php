...
<div id="details-top">
    <div class="container">
        <div class="description">
            <div class="title">action comics #1000</div>
    ...
    <div class="container">
        <div class="spec">
            ...
            <div class="row">
                ...
                <div class="text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Obcaecati deleniti laboriosam odio maxime molestias vitae, minus illo quo dolorem voluptate?</div>
            </div>
            <div class="row">
        ...
        <div class="spec">
            ...
            <div class="row">
                ...
                <div class="text">19.00$</div>
            </div>
            <div class="row">
                <div class="title">On sale date:</div>
                <div class="text">Oct 02 2018</div>
            </div>
        </div>
    </div>
</div>
